...
Заказчик - университет, организует курсы по программированию. В процессе прохождения курсов студенты выполняют домашние задания, а преподаватели их проверяют. Курс был значительно расширен, из-за чего возрос объём работ по проверке заданий и нагрузка на преподавателей.
...
### Преподаватель устанавливает дедлайн и критерии приемки

Бизнес-правила:

1. Преподаватель задает критерии и дедлайн в один момент времени только для одного задания
2. Преподаватель может менять критерии и дедлайн
3. Если задание уже принято и дедлайн истек, то задание остается принятым
4. После окончания дедлайна преподаватель не может изменить критерии
5. (Под попросом) Если задание принято, но критерии изменились, статус задания меняется на "не принято"? Если да, как вариант:

- Сама работа не теряется.
- Студент получает уведомление, что статус задания изменился.
- Студент может отправить задание на проверку повторно.
- В истории отображается, что критерии менялись и статус менялся.

6. Преподаватель сам определяет критерии и дедлайн

<br/>

**Преподаватель устанавливает дедлайн и критерии**
<br/>
![case 1](./pr_update_deadline_1.png)

<br/>

**Преподаватель меняет дедлайн и критерии(Работа еще не сдана)**
<br/>
![case 2](./pr_update_deadline_2.png)

<br/>

**Преподаватель меняет дедлайн и критерии(Работа уже сдана)**
<br/>
![case 3](./pr_update_deadline_3.png)

<br/>

**Преподаватель отменяет задание**
<br/>
![case 4](./pr_update_deadline_4.png)

<br/>

**Разрешение спорного случая**
<br/>
![case 5](./pr_update_deadline_5.png)
...
[Решение 1](./001-размещение-критериев-оценки.md)
[Решение 2](./002-запуск-кода-студентов.md)
