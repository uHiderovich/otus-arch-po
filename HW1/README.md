...
5. Если задание принято, но критерии изменились, статус задания меняется на "не принято", но сама работа не теряется. Студент получает уведомление, что статус задания изменился. Студент может отправить задание на проверку повторно. В истории отображается, что критерии менялись и статус менялся.
...
**Преподаватель вручную меняет оценку**
<br/>
